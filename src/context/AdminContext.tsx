...
const defaultBanners: Banner[] = [
  { id: 'b1', title: 'New Arrivals', subtitle: 'Check out the latest drops', imageUrl: '/assets/hero-sports.jpg', linkUrl: '/parts', isActive: true, position: 'hero' },
  { id: 'b2', title: 'Ramadan Sale', subtitle: 'Up to 30% off selected items', imageUrl: '/assets/shoe-basketball.jpg', linkUrl: '/parts', isActive: true, position: 'promo' },
];
