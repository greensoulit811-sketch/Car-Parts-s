        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 font-body text-sm text-primary-foreground/60">
              {categories.slice(0, 5).map(cat => (
                <li key={cat.id}><Link to={`/parts?category=${cat.slug}`} className="hover:text-neon transition-colors">{cat.name}</Link></li>
              ))}
              {categories.length === 0 && <li><Link to="/parts" className="hover:text-neon transition-colors">{t('footer.all_products')}</Link></li>}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 font-body text-sm text-primary-foreground/60">
              ...
              <li><Link to="/parts" className="hover:text-neon transition-colors">{t('nav.shop')}</Link></li>
            </ul>
          </div>
