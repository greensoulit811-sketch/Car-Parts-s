...
const SettingsPage = () => {
  ...
  const [form, setForm] = useState({
    ...
    whatsapp_number: '', instagram_handle: '', free_shipping_threshold: 30, currency: 'OMR',
    language: 'en',
  ...
  useEffect(() => {
    if (settings) {
      setForm({
        ...
        free_shipping_threshold: Number(s.free_shipping_threshold) || 30, currency: s.currency || 'OMR',
