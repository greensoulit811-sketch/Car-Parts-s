...
const CartPage = () => {
  ...
  const isDealerMOQMet = true; // Minimum order quantity removed
    ...
    return (
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="pt-32 pb-32 text-center px-4 flex-1 flex flex-col items-center justify-center">
          ...
          <Link to="/parts" className="inline-flex items-center gap-2 bg-neon text-accent-foreground px-8 py-4 font-body text-sm font-bold tracking-wider uppercase glow-neon hover:bg-neon-glow transition-all rounded-sm">
