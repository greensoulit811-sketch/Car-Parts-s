      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="pt-32 pb-20 text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/parts" className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-8 py-3 font-body text-sm font-bold tracking-wider uppercase hover:bg-primary/90 transition-all rounded-md">
